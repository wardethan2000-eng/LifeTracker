...
export default async function NoteTemplatesPage(): Promise<JSX.Element> {
  ...
  return (
    <Suspense fallback={<><PageHeader title="Note Templates" subtitle="Reusable note structures for common workflows. Built-in templates are read-only." /><div className="page-body"><div className="panel"><div className="panel__body--padded"><p className="note">Loading templates…</p></div></div></div></>}>
