    ...
    <RouteLoading>
      <header className="page-header">
        <div style={{ display: "grid", gap: 10 }}>
          <div className="skeleton-bar" style={{ width: 260, height: 28 }} />
          <div className="skeleton-bar" style={{ width: 360, height: 14 }} />
        </div>
      ...
      <div className="page-body" style={{ display: "grid", gap: 20 }}>
        <section className="stats-row">
          {[1, 2, 3, 4].map((item) => (
            <div key={item} className="stat-card">
              ...
              <div className="skeleton-bar" style={{ width: 54, height: 30, marginTop: 8 }} />
              <div className="skeleton-bar" style={{ width: 120, height: 12, marginTop: 8 }} />
            </div>
          ))}
        </section>
        ...
        <section className="panel">
          ...
          <div className="panel__body" style={{ padding: 0 }}>
            {[1, 2, 3].map((row) => (
              <div key={row} style={{ display: "flex", gap: 16, padding: "14px 16px", borderBottom: "1px solid var(--border)" }}>
                <div className="skeleton-bar" style={{ width: 240, height: 16 }} />
