...
export function InventoryAddDrawer({ householdId, categoryOptions, open, onClose }: InventoryAddDrawerProps): JSX.Element | null {
    ...
    <>
      ...
      >
        <div className="drawer-panel__header">
          ...
          <button type="button" className="button button--ghost button--sm" onClick={onClose} aria-label="Close drawer">✕</button>
        </div>
