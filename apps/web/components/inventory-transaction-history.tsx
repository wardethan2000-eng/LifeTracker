...
import { getHouseholdInventoryTransactions } from "../lib/api";
...
type ReferenceTypeFilter = "all" | "maintenance_log" | "project" | "hobby_session" | "manual";
                    ...
                    <tr key={transaction.id}>
                      ...
                      <td>
                        {transaction.referenceType ? (
                          <>
                            <div className="data-table__primary">{transaction.referenceType}</div>
