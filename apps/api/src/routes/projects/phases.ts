...
const toProjectPhaseChecklistItemResponse = (item: {
  id: string;
  phaseId: string;
  title: string;
  isCompleted: boolean;
...
const toProjectPhaseSupplyResponse = (supply: {
  id: string;
  phaseId: string;
  name: string;
  description: string | null;
...
const toProjectPhaseSummaryResponse = (phase: {
  ...
  procuredSupplyCount: phase.supplies.filter((item) => item.isProcured).length,
