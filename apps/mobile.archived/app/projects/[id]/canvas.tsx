...
export default function ProjectCanvasScreen() {
  ...
  const { data: canvases = [], isLoading, refetch, isRefetching } = useQuery({
    queryKey: ["canvases", "project", id, householdId],
    queryFn: () => getCanvases(householdId, { entityType: "project", entityId: id }),
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <EmptyState
              ...
              body="Create a canvas for this project on the web dashboard."
            />
          }
