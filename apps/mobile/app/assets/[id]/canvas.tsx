...
export default function AssetCanvasScreen() {
  ...
  const { data: canvases = [], isLoading, refetch, isRefetching } = useQuery({
    queryKey: ["canvases", "asset", id, householdId],
    queryFn: () => getCanvases(householdId, { entityType: "asset", entityId: id }),
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <EmptyState
              ...
              body="Create a canvas for this asset on the web dashboard."
            />
          }
