...
export default function IdeaCanvasScreen() {
  ...
  const { data: canvases = [], isLoading, refetch, isRefetching } = useQuery({
    queryKey: ["canvases", "idea", id, householdId],
    queryFn: () => getCanvases(householdId, { entityType: "idea", entityId: id }),
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <EmptyState
              ...
              body="Create a canvas for this idea on the web dashboard."
            />
          }
