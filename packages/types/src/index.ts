...
export const notificationTypeValues = ["due_soon", "due", "overdue", "digest", "announcement", "inventory_low_stock", "inventory_expiring_soon", "note_reminder"] as const;
...
export const ideaCanvasSchema = z.object({
  ...
  backgroundImageX: z.number().default(0),
  backgroundImageY: z.number().default(0),
  backgroundImageScale: z.number().default(1),
  backgroundImageLocked: z.boolean().default(false),
  backgroundImageCropX: z.number().nullable().default(null),
  backgroundImageCropY: z.number().nullable().default(null),
  backgroundImageCropW: z.number().nullable().default(null),
  backgroundImageCropH: z.number().nullable().default(null),
...
export const updateCanvasSettingsSchema = z.object({
  ...
  backgroundImageScale: z.number().min(0.01).max(100).optional(),
  backgroundImageLocked: z.boolean().optional(),
  backgroundImageCropX: z.number().min(0).max(1).nullable().optional(),
  backgroundImageCropY: z.number().min(0).max(1).nullable().optional(),
  backgroundImageCropW: z.number().min(0).max(1).nullable().optional(),
  backgroundImageCropH: z.number().min(0).max(1).nullable().optional(),
...
export const canvasObjectCategoryValues = [
  ...
  "tool", "person", "electronics", "landscape", "custom",
] as const;
